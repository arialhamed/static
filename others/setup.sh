...
echo "Essential apt & snap update/refresh"
sudo apt update
sudo apt upgrade -y
sudo snap refresh

echo "Installing all packages recommended by Ari"
...
echo "Removing KTorrent (replaced with QBitTorrent"
...
echo "Installing pdftk, zoom, openjdk, visual studio code, & android studio"
...
# aliases
echo "Inserting aliases into ~/.bashrc"
