...
echo "alias backup='rsync -aP ~/snap/dolphin-emulator/common/.local/share/dolphin-emu/GC/MemoryCardA.USA.raw ~/Repos/arialhamed/static/others/MemoryCardA.USA.raw'" >> ~/.bashrc
